...
const galleryImages = [
  ...
  },
  {
    id: 3,
    image:
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/1e/a8/4c/caption.jpg?w=1400&h=-1&s=1",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the breathtaking beauty of ancient Egypt through our
            curated collection of photographs from unforgettable tours and
            experiences.
          </p>
        </div>
              ...
              <button
                onClick={() =>
                  setSelectedImage((prev) =>
                    (prev ?? 0) > 0 ? (prev ?? 0) - 1 : galleryImages.length - 1
                  )
                }
