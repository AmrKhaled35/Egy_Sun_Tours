      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            <div className="bg-green-600 text-white px-6 py-3 rounded-lg flex items-center space-x-3">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Read authentic experiences from travelers who discovered the wonders of Egypt with our expert guides. Over 161 five-star reviews on TripAdvisor.
          </p>
          <Button 
        ...
        <div className="text-center mt-16 bg-white rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-gray-600 mb-6">
            Join hundreds of satisfied travelers who have discovered the magic of Egypt with our expert guides.
          </p>
          <Button 
            size="lg" 
