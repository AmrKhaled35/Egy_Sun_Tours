...
const TripsGrid = () => {
  ...
  const categories = ['All', ...Array.from(new Set(allTrips.map(trip => trip.category)))];
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-xl md:text-2xl mb-6 max-w-3xl">
                    Discover the wonders of ancient Egypt with our expertly crafted tours and unforgettable experiences
                  </p>
                </div>
              </div>
            </div>
